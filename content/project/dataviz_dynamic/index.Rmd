...
library(pacman)
p_load(tidyverse, readxl, lubridate, purrr, janitor, scales, plotly, tmap, leaflet, DT,lubridate,sf,xfun, ggridges, ggmap,tidycensus, tidyverse,leaflet, geojsonio, sf, tmap, tmaptools, DT, xfun,ceramic, gganimate, tidyverse, geojsonio,  gifski, transformr, ggspatial)
```
